...
*	Defines a bunch of Stupid data structures needed for Kernel Tracing
*	Last revision: 11/25/2016
*
*   Copyright© 2016 Andrea Allievi (MSTIC), Richard Johnson (TALOS) 
*	All right reserved
**********************************************************************/
...
struct PT_TRACE_DESC {
	...
	BOOL bTraceKernel;						// Trace by CPL: TRUE if I need to trace even Kernel mode components
